...
// 1) Définir BASE_PATH si nécessaire
...
<main class="container mt-4">
    <?php // Affiche le BigTitle (masqué par $hideTitle=false dans le layout) ?>
    <?php require BASE_PATH . '/src/views/bigTitle.php'; ?>

    <?php // Fiche “Mes Informations” ?>
    ...
    <?php // ======= Mes covoiturages (Chauffeur) ======= ?>
    ...
    <?php else: ?>
        <p class="text-muted">Vous devez être passager pour voir et valider vos trajets réservés.</p>
    <?php endif; ?>
</main>
<?php
