...
// 1) Définir BASE_PATH et démarrer la session + inactivité
...
<main class="container mt-4">
  ...
  <h2 class="mt-5 mb-3">Mes covoiturages (Chauffeur)</h2>
  <?php if ($isChauffeur): ?>
  ...
  <h2 class="mt-5 mb-3">Mes covoiturages (Passager)</h2>
  <?php if ($isPassager): ?>
